          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="w-8 h-8 rounded-full bg-white/70 hover:bg-white border border-black/10 flex items-center justify-center text-black hover:scale-110 active:scale-95 transition-all shadow-sm"
              >
                <GithubIcon />
              </a>
            </div>
